            ...
            <div className='text-center'>
                ...
                <div className='w-max flex items-center gap-2 mx-auto justify-center'>
                    <Image src={isDarkMode ? assets.mail_icon_dark : assets.mail_icon} alt='' className='w-6' />
                     darwin.mariappan2001@gmail.com
                </div>
            </div>

            <div className='text-center sm:flex items-center justify-between border-top border-gray-400 mx-[10%] mt-12 py-6'>
                <p>© 2025 Darwin. All rights reserved.</p>
                <ul className='flex items-center gap-10 justify-center mt-4 sm:mt-0'>
                    <li><a target='_blank' href='https://github.com/Darwin192001'>GitHub</a></li>
                    <li><a target='_blank' href='https://www.linkedin.com/in/darwin-mariappan/'>LinkedIn</a></li>
                </ul>
            </div>
        </div>
    )
