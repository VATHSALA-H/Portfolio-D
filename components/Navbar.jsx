...
const Navbar = ({isDarkMode,setIsDarkMode}) => {
  ...
  return (
    ...
    justify-between z-50 ${isScroll ? 'bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20' : ''} `}>
        ...
        <a href='#top'>
          <Image src={isDarkMode ? assets.logo_dark : assets.logov} className='w-28 cursor-pointer mr-14' alt='logo' />
        </a>
        ...
        <div className='flex items-center gap-4'>
          ...
          <a href='#contact' className='hidden c-lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo dark:border-white/50'>
            <span>Contact</span>
            <Image src={isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} className='w-3' alt='email' />
          </a>
