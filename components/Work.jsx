...
const Work = ({ isDarkMode }) => {
    return (
        <motion.div initial={{ opacity: 0 }}
            ...
            <motion.div initial={{ opacity: 0}}
                            whileInView={{ opacity: 1}}
                            transition={{ duration: 0.6, delay: 0.9 }} className="flex justify-center items-center flex-wrap my-10 gap-5 dark:text-black">
                {workData.map((project, index) => (
                    <motion.div
                        ...
                        style={{ backgroundImage: `url(${project.bgImage.src})`, height: '300px' }} // Use bgImage.src for imported images
                    >
